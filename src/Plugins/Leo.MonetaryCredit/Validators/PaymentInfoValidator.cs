...
namespace Leo.MonetaryCredit.Validators
{
    public class PaymentInfoValidator : AbstractValidator<PaymentInfoModel>
    {
        public PaymentInfoValidator(MonetaryCreditPaymentSettings monetaryCreditPaymentSettings, ITranslationService translationService)
        {
            //if (monetaryCreditPaymentSettings.Use3DS)
            //    return;
